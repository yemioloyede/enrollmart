...
namespace EnrolTraining.Controllers
{
    public class FilemanagerController : Controller
    {
        ...
        /// </summary>
        private Filemanager.FilemanagerConfig config = new Filemanager.FilemanagerConfig();
        ...
        public ActionResult Index(string mode, string path = null)
        {
            ...
            try
            {
                switch (mode)
                {
                    ...
                    default:
                        return View(); /*Content(Error(string.Format("{0} not implemented", mode)));*/
                }
            }
        ...
        private bool IsInRootPath(string path)
        {
            ...
            string path2 = Path.GetFullPath(config.RootPath);
            bool test = path1.StartsWith(path2);
